...
echo "================================================"
echo "NOTICE: Script Location Changed"
echo "================================================"
echo ""
echo "This script has been moved to: scripts/dev/test_verification.sh"
echo "Please update your workflows to use the new location."
echo ""
echo "Continuing with verification test..."
echo ""
echo "================================================"
