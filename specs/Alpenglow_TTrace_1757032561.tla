...
---- MODULE Alpenglow_TTrace_1757032561 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1757032561.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1757032561.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Alpenglow_TTrace_1757032561 ----
CONSTANTS
    Validators = { v1 , v2 , v3 }
    ByzantineValidators = { }
    OfflineValidators = { }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 05 06:06:03 IST 2025