...
---- MODULE Alpenglow_TTrace_1757032603 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1757032603.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1757032603.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Alpenglow_TTrace_1757032603 ----
CONSTANTS
    Validators = { v1 , v2 , v3 }
    ByzantineValidators = { }
    OfflineValidators = { }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 05 06:06:45 IST 2025