...
---- MODULE Alpenglow_TTrace_1757032500 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1757032500.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1757032500.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([networkDroppedMessages |-> ,currentSlot |-> ,rotorRelayAssignments |-> ,votorVotedBlocks |-> (v1 :> <<{[view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1]}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),networkMessageBuffer |-> ,networkDeliveryTime |-> ,rotorReceivedShreds |-> ,networkMessageQueue |-> ,failureStates |-> ,votorTimeoutExpiry |-> (v1 :> 3 @@ v2 :> 3 @@ v3 :> 3),votorView |-> (v1 :> 1 @@ v2 :> 1 @@ v3 :> 1),networkPartitions |-> ,votorSkipVotes |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),votorGeneratedCerts |-> <<{}, {}>>,bandwidthMetrics |-> ,rotorRepairRequests |-> ,deliveredBlocks |-> ,rotorBlockShreds |-> ,clock |-> ,rotorReconstructionState |-> ,rotorDeliveredBlocks |-> ,votorReceivedVotes |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),rotorBandwidthUsage |-> ,finalizedBlocks |-> ,rotorReconstructedBlocks |-> ,latencyMetrics |-> ,finalizedBySlot |-> ,votorFinalizedChain |-> <<>>,messages |-> ,rotorShredAssignments |-> ])
    >>
----
...
---- CONFIG Alpenglow_TTrace_1757032500 ----
CONSTANTS
    Validators = { v1 , v2 , v3 }
    ByzantineValidators = { }
    OfflineValidators = { }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 05 06:05:01 IST 2025