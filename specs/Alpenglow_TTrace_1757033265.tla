---- MODULE Alpenglow_TTrace_1757033265 ----
...
_inv ==
    ~(
        ...
        currentSlot = ()
        /\
        rotorRelayAssignments = ((v1 :> 1..3 @@ v2 :> 1..3 @@ v3 :> 1..3))
        /\
        votorVotedBlocks = ()
        /\
        ...
        deliveredBlocks = ()
        /\
        rotorBlockShreds = (<<(v1 :> {[blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 1>>, index |-> 1, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 2>>, index |-> 2, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"parity", {}, 0>>, index |-> 3, isParity |-> TRUE]} @@ v2 :> {[blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 1>>, index |-> 1, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 2>>, index |-> 2, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"parity", {}, 0>>, index |-> 3, isParity |-> TRUE]} @@ v3 :> {[blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 1>>, index |-> 1, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 2>>, index |-> 2, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"parity", {}, 0>>, index |-> 3, isParity |-> TRUE]})>>)
        /\
        clock = ()
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1757033265.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1757033265.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([networkDroppedMessages |-> 0,currentSlot |-> 1,rotorRelayAssignments |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),votorVotedBlocks |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),networkMessageBuffer |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),networkDeliveryTime |-> <<>>,rotorReceivedShreds |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),networkMessageQueue |-> {},failureStates |-> (v1 :> "active" @@ v2 :> "active" @@ v3 :> "active"),votorTimeoutExpiry |-> (v1 :> 3 @@ v2 :> 3 @@ v3 :> 3),votorView |-> (v1 :> 1 @@ v2 :> 1 @@ v3 :> 1),networkPartitions |-> {},votorSkipVotes |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),votorGeneratedCerts |-> <<{}, {}>>,bandwidthMetrics |-> (v1 :> 0 @@ v2 :> 0 @@ v3 :> 0),rotorRepairRequests |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),deliveredBlocks |-> {},rotorBlockShreds |-> <<>>,clock |-> 0,rotorReconstructionState |-> (v1 :> <<>> @@ v2 :> <<>> @@ v3 :> <<>>),rotorDeliveredBlocks |-> {},votorReceivedVotes |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),rotorBandwidthUsage |-> (v1 :> 0 @@ v2 :> 0 @@ v3 :> 0),finalizedBlocks |-> <<{}, {}>>,rotorReconstructedBlocks |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),latencyMetrics |-> <<0, 0>>,finalizedBySlot |-> <<{}, {}>>,votorFinalizedChain |-> (v1 :> <<>> @@ v2 :> <<>> @@ v3 :> <<>>),messages |-> {},rotorShredAssignments |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {})]),
    ...
    ([networkDroppedMessages |-> ,currentSlot |-> ,rotorRelayAssignments |-> (v1 :> 1..3 @@ v2 :> 1..3 @@ v3 :> 1..3),votorVotedBlocks |-> ,networkMessageBuffer |-> ,networkDeliveryTime |-> ,rotorReceivedShreds |-> ,networkMessageQueue |-> ,failureStates |-> ,votorTimeoutExpiry |-> ,votorView |-> ,networkPartitions |-> ,votorSkipVotes |-> ,votorGeneratedCerts |-> ,bandwidthMetrics |-> ,rotorRepairRequests |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),deliveredBlocks |-> ,rotorBlockShreds |-> <<(v1 :> {[blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 1>>, index |-> 1, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 2>>, index |-> 2, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"parity", {}, 0>>, index |-> 3, isParity |-> TRUE]} @@ v2 :> {[blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 1>>, index |-> 1, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 2>>, index |-> 2, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"parity", {}, 0>>, index |-> 3, isParity |-> TRUE]} @@ v3 :> {[blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 1>>, index |-> 1, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"data", [view |-> 1, slot |-> 1, timestamp |-> 0, signature |-> [signer |-> v1, message |-> 1, valid |-> TRUE], hash |-> 1, parent |-> 0, transactions |-> {}, data |-> <<>>, proposer |-> v1], 2>>, index |-> 2, isParity |-> FALSE], [blockId |-> 1, signature |-> <<>>, data |-> <<"parity", {}, 0>>, index |-> 3, isParity |-> TRUE]})>>,clock |-> ,rotorReconstructionState |-> (v1 :> <<>> @@ v2 :> <<>> @@ v3 :> <<>>),rotorDeliveredBlocks |-> {},votorReceivedVotes |-> ,rotorBandwidthUsage |-> (v1 :> 0 @@ v2 :> 0 @@ v3 :> 0),finalizedBlocks |-> ,rotorReconstructedBlocks |-> ,latencyMetrics |-> ,finalizedBySlot |-> ,votorFinalizedChain |-> ,messages |-> ,rotorShredAssignments |-> ])
    >>
----
...
---- CONFIG Alpenglow_TTrace_1757033265 ----
CONSTANTS
    Validators = { v1 , v2 , v3 }
    ByzantineValidators = { }
    OfflineValidators = { }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 05 06:17:47 IST 2025