...
---- MODULE Alpenglow_TTrace_1757032344 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1757032344.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1757032344.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([networkDroppedMessages |-> 0,currentSlot |-> 1,rotorRelayAssignments |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),votorVotedBlocks |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),networkMessageBuffer |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),networkDeliveryTime |-> ,rotorReceivedShreds |-> ,networkMessageQueue |-> {},failureStates |-> ,votorTimeoutExpiry |-> (v1 :> 3 @@ v2 :> 3 @@ v3 :> 3),votorView |-> (v1 :> 1 @@ v2 :> 1 @@ v3 :> 1),networkPartitions |-> {},votorSkipVotes |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),votorGeneratedCerts |-> <<{}, {}>>,bandwidthMetrics |-> (v1 :> 0 @@ v2 :> 0 @@ v3 :> 0),rotorRepairRequests |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),deliveredBlocks |-> {},rotorBlockShreds |-> <<>>,clock |-> 1,rotorReconstructionState |-> (v1 :> <<>> @@ v2 :> <<>> @@ v3 :> <<>>),rotorDeliveredBlocks |-> {},votorReceivedVotes |-> (v1 :> <<{}, {}>> @@ v2 :> <<{}, {}>> @@ v3 :> <<{}, {}>>),rotorBandwidthUsage |-> (v1 :> 0 @@ v2 :> 0 @@ v3 :> 0),finalizedBlocks |-> <<{}, {}>>,rotorReconstructedBlocks |-> ,latencyMetrics |-> <<0, 0>>,finalizedBySlot |-> <<<<>>, <<>>>>,votorFinalizedChain |-> <<>>,messages |-> {},rotorShredAssignments |-> ])
    >>
----
...
---- CONFIG Alpenglow_TTrace_1757032344 ----
CONSTANTS
    Validators = { v1 , v2 , v3 }
    ByzantineValidators = { }
    OfflineValidators = { }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 05 06:02:25 IST 2025