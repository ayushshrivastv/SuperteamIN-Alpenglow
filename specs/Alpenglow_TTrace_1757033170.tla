---- MODULE Alpenglow_TTrace_1757033170 ----
...
_inv ==
    ~(
        ...
        votorView = ()
        /\
        networkPartitions = ({[startTime |-> 0, partition1 |-> {v2, v3}, partition2 |-> {v1}, healed |-> FALSE]})
        /\
        votorSkipVotes = ()
        /\
        votorGeneratedCerts = ()
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1757033170.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1757033170.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([networkDroppedMessages |-> 0,currentSlot |-> ,rotorRelayAssignments |-> ,votorVotedBlocks |-> ,networkMessageBuffer |-> (v1 :> {} @@ v2 :> {} @@ v3 :> {}),networkDeliveryTime |-> <<>>,rotorReceivedShreds |-> ,networkMessageQueue |-> {},failureStates |-> ,votorTimeoutExpiry |-> ,votorView |-> ,networkPartitions |-> {[startTime |-> 0, partition1 |-> {v2, v3}, partition2 |-> {v1}, healed |-> FALSE]},votorSkipVotes |-> ,votorGeneratedCerts |-> ,bandwidthMetrics |-> ,rotorRepairRequests |-> ,deliveredBlocks |-> ,rotorBlockShreds |-> ,clock |-> 0,rotorReconstructionState |-> ,rotorDeliveredBlocks |-> ,votorReceivedVotes |-> ,rotorBandwidthUsage |-> ,finalizedBlocks |-> ,rotorReconstructedBlocks |-> ,latencyMetrics |-> ,finalizedBySlot |-> ,votorFinalizedChain |-> ,messages |-> ,rotorShredAssignments |-> ])
    >>
----
...
---- CONFIG Alpenglow_TTrace_1757033170 ----
CONSTANTS
    Validators = { v1 , v2 , v3 }
    ByzantineValidators = { }
    OfflineValidators = { }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Sep 05 06:16:12 IST 2025